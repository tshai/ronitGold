...
<div class="eventLink">
              <table cellspacing="20" border="0"><tr>
               <td><a href="gallery1.aspx" style="color:#f26522"><p class="galleryItemHeader">Landscape</p></a></td>
              </tr></table>
          </div>
 ...
 <asp:ListView ID="ListView1" runat="server" DataKeyNames="paintID" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Paints] where category=1 order by position "></asp:SqlDataSource>
            </div> 
