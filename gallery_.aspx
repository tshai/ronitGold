...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="img_container">
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="eventID" DataSourceID="SqlDataSource1"
                ...
                <div class="eventItem">
                    ...
                    <div class="img_container">
                        <asp:ListView ID="ListView2" runat="server" DataKeyNames="eventID" DataSourceID="sdsEPic">
                            ...
                            <ItemTemplate>
                                <div class="galleryItem" style="height: 110px; padding: 3px; width: 110px;">
                                    <a href="paints/large/<%# Eval("eventImage") %>" rel="sexylightbox[group1]" title="<%# Eval("engDescription") %>">
                                        <img src="paints/thumbs/<%# Eval("eventImage") %>" alt="<%# Eval("eventImage") %>"
                        ...
                        <asp:SqlDataSource ID="sdsEPic" runat="server" ConnectionString="<%$ ConnectionStrings:paint %>"
                            SelectCommand="SELECT eventID, eventImage, engDescription FROM eventPics WHERE eventID = @eventID">
                            <SelectParameters>
            ...
            <EmptyDataTemplate>
                <h3>
                    There are no events at this time...</h3>
            </EmptyDataTemplate>
        </asp:ListView>
