...
<div class="eventLink">
              <table cellspacing="20" border="0"><tr>
               <td><a href="gallery2.aspx" style="color:#f26522"><p class="galleryItemHeader">Cityscape</p></a></td>
              </tr></table>
          </div>
 ...
 <asp:ListView ID="ListView1" runat="server" DataKeyNames="paintID" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Paints] where category=2 order by position "></asp:SqlDataSource>
            </div> 
