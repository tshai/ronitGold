...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<div class="video-area1" id="video-area1" style="height: 600px">
		...
		<div class="coverDiv" style="opacity: <%=populateClassFromDB.getReadySentencesFromDomain(int.Parse(Session["domainListID"].ToString()), "sliderVideoOpacity") %>"></div>
		<video autoplay muted loop id="myVideo">
			<source src="/media/video/<%=populateClassFromDB.getReadySentencesFromDomain(int.Parse(Session["domainListID"].ToString()), "sliderVideo") %>" type="video/mp4">
			Your browser does not support HTML5 video.
		</video>
		<div id="slogenMainPage">
			<h3><%=populateClassFromDB.getReadySentencesFromDomain(int.Parse(Session["domainListID"].ToString()), "ArchitectureAgency") %></h3>
			<h2><%=populateClassFromDB.getReadySentencesFromDomain(int.Parse(Session["domainListID"].ToString()), "ModernDesignAndArchitecture") %></h2>
		</div>
	</div>
	<!-- Video END -->
